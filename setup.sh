...
sudo scutil --set ComputerName "Zen4"
sudo scutil --set HostName "Zen4"
sudo scutil --set LocalHostName "Zen4"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Zen4"
