...
#
# Requires a Powerline-patched font for the segment separators (U+E0B0).
#
### Minimal git helpers
# Only parse_git_dirty() is needed by this prompt; ported from OMZ git.zsh
# stripped to the essentials (no async, no submodule flags).
...
# prompt_subst: evaluate $() / ${} inside PROMPT (OMZ set this via theme-and-appearance.zsh)
setopt prompt_subst
